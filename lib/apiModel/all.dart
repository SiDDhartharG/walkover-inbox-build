...
//   Mail? get mail => _mail;
//   List<dynamic>? get mailNotes => _mailNotes;
//
//   All({
//       String? id,
//       String? mailOwner,
...
//     if (json['mail_notes'] != null) {
//       _mailNotes = [];
//       json['mail_notes'].forEach((v) {
//         _mailNotes?.add(dynamic.fromJson(v));
//       });
//     }
//   }
//
...
//     }
//     if (_mailNotes != null) {
//       map['mail_notes'] = _mailNotes?.map((v) => v.toJson()).toList();
//     }
//     return map;
//   }
//
